...
![**ISBTWBDD2023** **ISBTClinical**](wbdd-2023-banner.png){width=600}
...
Blood donation is a novel act of lifesaving practice for people who face blood loss due to road traffic accidents, surgery, pregnancy complications, and diseases like malaria, anemia, dengue fever, and intestinal parasites which increase the demand for blood
...
![**Blood is Love**](Blood_logo-1.png){width=100}
...
-	Syringes, test tubes
- Blood screening test kits
- Blood bags storage (up to 42 days)
-	Refreshment cookies and drinks for donors
- T-short + hat x 50


# Workflow of Blood Donation (staffs)
- two sites: HGH Blood Bank + main campus of University of Hargeisa
-	Registration (2+5)
...
# Workflow of Oral Health check (staffs)
- computer + project + screen
- ultrasound for head and neck examination
- tongue depressor + penlight
- Dr. Tex Chi + Dr. Omar + Dr. Fadumo
