...
for x in range(len(structured_files)-1): # 0:48
  ...
  for y in range(x + 1, len(structured_files)-1): # compare x and rest of list
    if structured_files[x]['TH_id'] == structured_files[y]['TH_id']:
      ...
      # merge tiles
      tiles = [pyvips.Image.new_from_file(f"/mnt/c/Users/User/Documents/TissueFAXS_OVH2022/TMUH2017/OVH_TMUH_2017_WSI_CK13_Box1246/{TH_id}-Region {yr}.tif", access="sequential") for yr in regions] 
